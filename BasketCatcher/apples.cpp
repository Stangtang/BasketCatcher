...
void SpawnApple(Apple* apples)
{
	...
	float posX = GetRandomValue(APPLE_SOURCE_WIDTH / 2, SCREEN_WIDTH - (APPLE_SOURCE_WIDTH / 2));

	SetAppleAt(apples, availableIndex, CLITERAL(Vector2) { posX, -APPLE_SOURCE_HEIGHT }, fallSpeed);
}