...
int main()
{
	...
	InitWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "BasketCatcher");

	_atlasApple = LoadTexture("apple_60x60.png");
	_atlasBasket = LoadTexture("basket.png");
...
void UpdateDrawFrame(void)
{
	...
	BeginDrawing();
		...
		if (GetGameState() == END)
		{
			...
			int minutes = (int)(_timeGameEnd - _timeGameStart) / 60;
			int seconds = (int)(_timeGameEnd - _timeGameStart) % 60;
